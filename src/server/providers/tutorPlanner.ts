...
function buildSystemPrompt(input: TutorTurnInput) {
  return [
    ...
    'Treat orange drawings, arrows, circles, and doodles as visual attention guides. Infer the intended target from arrow heads, enclosed areas, nearby labels, and stroke direction.',
